    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <a href="/admin/transaksi/detail/selesai/{{ Request::segment(3) }}" class="btn btn-success"><i class="fas fa-check"></i> Konfirmasi</a>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <form action="" method="GET">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ $transaksi->total }}" name="total_belanja" disabled class="form-control"
                            id="">
                    </div>
